...
**Krun Dev** — software engineer and systems analyst focused on backend architecture, distributed systems, and API reliability in modern microservice environments.
